...
手番なら： どう石を取っても、石が残る。後手が手を抜かなければ負け
相手なら： 先手が石をどう残しても、全部取る方法あり。自分が手を抜かなければ自分の勝ち
```
...
相手なら： 先手が石を１つだけ取るでもなければ、机の上に石が４つ残るということはない。先手が手を抜かなければ負け
```
...
相手なら： 先手が石を２つ取るでもなければ、机の上に石が４つ残るということはない。先手が手を抜かなければ負け
```
...
相手なら： 先手が石を３つ取るでもなければ、机の上に石が４つ残るということはない。先手が手を抜かなければ負け
```
...
手番なら： どう石を取っても、５つ～７つの石が残る。後手には残りの石の数を４つにする方法がある。後手が手を抜かなければ負け
相手なら： 先手が石をどう残しても、自分には残りの石の数を４つにする方法あり。自分が手を抜かなければ自分の勝ち
```
